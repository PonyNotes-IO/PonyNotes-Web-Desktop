...
{
    @Autowired
    private IXmAfUserService afUserService;
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, XmAfUser afUser)
    {
        List<XmAfUser> list = afUserService.selectAfUserList(afUser);
        ExcelUtil<XmAfUser> util = new ExcelUtil<>(XmAfUser.class);
    ...
    @PostMapping
    public AjaxResult add(@RequestBody XmAfUser afUser)
    {
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody XmAfUser afUser)
    {
