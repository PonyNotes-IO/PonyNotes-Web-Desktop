...
public interface SysUserMapper
{
    ...
    public SysUser loginPhonePassword(@Param("phone")String phone, @Param("password")String password);

    public SysUser loginEmailPassword(@Param("email")String email, @Param("password")String password);
}
