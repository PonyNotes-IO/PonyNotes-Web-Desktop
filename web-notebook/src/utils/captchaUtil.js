...
export  function sendCaptcha({
  ...
  // const response = await axiosInstance.post(api_path, { account: inputValue });
  ...
  startCountdown = true;
  console.log(setIsSendingCaptcha)
...
export async function verifyCaptcha({
  ...
  try {
    ...
    //   type: captchaType
    // });
    const response = request.post('/api/auth/verify-captcha', {
      account: inputValue,
      accountType: isPhoneNumber ? 'phone' : 'email',
      captcha: captchaValue,
      type: captchaType
