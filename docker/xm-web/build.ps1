...
# 构建Docker镜像
$buildCommand = "docker build -t xm-web:$Version ."
...
# 保存Docker镜像
$saveCommand = "docker save -o xm-web.tar xm-web:$Version"
...
Write-Host "镜像已保存为: $(Get-Location)\xm-web.tar" -ForegroundColor Yellow