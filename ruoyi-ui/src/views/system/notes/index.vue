  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否公开" prop="isPublic">
        <el-select v-model="queryParams.isPublic" placeholder="是否公开" clearable>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="创建者名称" prop="userName">
              <el-input v-model="form.userName" placeholder="请输入创建者名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="分类ID" prop="categoryId">
              <el-input v-model="form.categoryId" placeholder="请输入分类ID" type="number" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import { listNotes, getNotes, delNotes, addNotes, updateNotes } from "@/api/system/notes"
