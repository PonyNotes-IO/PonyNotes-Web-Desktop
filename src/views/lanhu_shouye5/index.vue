<template>
  <div class="page flex-col">
    ...
    <div class="group_8 flex-col">
      ...
      <span class="text_17">知识站点</span>
      <span class="text_18">将笔记一键发布为静态网站，打造专属知识库或项目主页，支持自定义域名和样式</span>
      ...
      <div class="box_3 flex-col"><div class="box_4 flex-col"></div></div>
      <div class="box_5 flex-row">
        <div class="text-wrapper_8 flex-col justify-between">
          <span class="text_26">图形辅助绘图</span>
          <span class="text_27">自动识别手绘图形，生成标准线条、箭头、图标，让思维导图和草图更清晰专业</span>
        </div>
      ...
      <div class="text-group_3 flex-col justify-between">
        <span class="text_35">实时协同</span>
        <span class="text_36">多人在线同时编辑白板，支持远程头脑风暴与教学演示</span>
      </div>
    ...
    <div class="group_11 flex-col">
      ...
      <div class="section_5 flex-row justify-between">
        <div class="image-text_3 flex-row justify-between">
          ...
          />
          <span class="text-group_6">iPhone</span>
        </div>
        <div class="image-text_4 flex-row justify-between">
          ...
          />
          <span class="text-group_7">iPad</span>
        </div>
        <div class="image-text_5 flex-row justify-between">
          ...
          />
          <span class="text-group_8">Windows</span>
        </div>
        <div class="image-text_6 flex-row justify-between">
          ...
          />
          <span class="text-group_9">MacOS</span>
        </div>
        <div class="image-text_7 flex-row justify-between">
          ...
          />
          <span class="text-group_10">Android</span>
        </div>
        <div class="image-text_8 flex-row justify-between">
          ...
          />
          <span class="text-group_11">浏览器</span>
        </div>
      </div>
    </div>
    <div class="group_12 flex-col">
      ...
      <div class="block_1 flex-row">
        <div class="image-text_9 flex-row justify-between">
          ...
          />
          <span class="text-group_12">小马笔记</span>
        </div>
