  ...
  <div class="page flex-col">
    ...
    <div class="box_3 flex-row">
      <div class="input_1 flex-col">
        <input 
          class="text_7" 
          :placeholder="accountType === 'phone' ? '158 7123 1937' : 'example@email.com'" 
    ...
    <div class="box_4 flex-row">
      <div class="text-wrapper_1 flex-col"><span class="text_8">输入设置的密码</span></div>
      <div class="input_1 flex-col">
        <input 
          class="text_7" 
          type="password" 
    ...
    <div class="text-wrapper_2 flex-row justify-between" v-if="showError">
      <span class="text_9">账号和密码不匹配，请重新输入</span>
...
export default {
  ...
  methods: {
    // 从URL参数初始化数据
    initDataFromQuery() {
      const { accountType, isFirstLogin, account } = this.$route.query;
    ...
    getCommonParams() {
      return {
        ...
        lastPage: this.$route.fullPath // 记录上一个页面，以便登录后返回
      };
    },
